...
public:
  ...
  */
  static Vector2BH<> rotate(const Vector2BH<>& v, float a);
  ...
  * @return The rotated vector
  */
  static Vector2BH<int> rotate(const Vector2BH<int>& v, float a);
...
public:
  ...
  */
  ...
  static bool calculatePointOnField(const Vector2BH<>& image, const float& fieldZ, const CameraMatrix& cameraMatrix, const CameraInfo& cameraInfo,
                                    Vector3BH<>& field);
  static bool calculatePointOnField(const Vector2BH<>& point, const CameraMatrix& cameraMatrix, const CameraInfo& cameraInfo, Vector2BH<>& pointOnField);
